...
| REQ-017 | A subscription-scope monthly Cost Management budget filtered to the project resource group is configured at JPY 2,000, with actual-cost notifications at 50%, 80%, and 100%; the recipient is supplied only as a private deployment-time parameter | docs/context/design-sessions/2026-07-claude-planning/ + ADR-0007 + Issue #31 human decision | Bicep/configuration review; deployed-budget inspection and notification test; monthly cost report | accepted |
